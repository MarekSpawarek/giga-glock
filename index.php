...
<html lang="pl">
    ...
    <body>        
        <div class="dropdown mt-4 ms-4">
            <button type="button" class="glassmorphism text-white dropdown-toggle btn d-flex align-items-center font-open-sans" data-bs-toggle="dropdown">
        ...
        <div class="date-time font-open-sans">
            <div class="glassmorphism" style="text-align: center; border-radius: 2rem; padding: 3rem;">
